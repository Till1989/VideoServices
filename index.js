...
vPage=new vidPage(chPage.user,chPage.videos[chPage.videos.findIndex(vid=>vid.name=="Приехал на работу и, бл#, домой хочу")]);
vPage.Like();
vPage.Comment("Та же фигня(((");
